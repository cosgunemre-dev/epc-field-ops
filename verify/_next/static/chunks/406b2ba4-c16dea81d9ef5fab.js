"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[51],{4563:function(e,t,r){r.d(t,{p:function(){return rh},z:function(){return e7}});var n,i=r(1480),s=r(9074),a=r(3693),o=r(5980);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let l=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function u(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${i.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e,t,r=!1){if((0,i.rh)(e.app))return Promise.reject(m(e));let n="signIn",s=await e5(e,n,t),a=await e3._fromIdTokenResponse(e,n,s);return r||await e._updateCurrentUser(a.user),a}function e7(e,t,r,n){return(0,s.m9)(e).onAuthStateChanged(t,r,n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
